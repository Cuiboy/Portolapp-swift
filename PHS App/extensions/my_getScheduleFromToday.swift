...
func my_getSchedule(type: Int, date: Date?) -> [Date]? {
    ...
    case 15:
        //Passion Day
        return [DateFromTime(hour: 8, minute: 0), DateFromTime(hour: 8, minute: 45), DateFromTime(hour: 8, minute: 51), DateFromTime(hour: 9, minute: 36),  DateFromTime(hour: 9, minute: 36), DateFromTime(hour: 9, minute: 46), DateFromTime(hour: 9, minute: 52), DateFromTime(hour: 10, minute: 37),DateFromTime(hour: 10, minute: 43), DateFromTime(hour: 11, minute: 28), DateFromTime(hour: 11, minute: 28), DateFromTime(hour: 12, minute: 3), DateFromTime(hour: 12, minute: 9), DateFromTime(hour: 12, minute: 54), DateFromTime(hour: 13, minute: 0), DateFromTime(hour: 13, minute: 45), DateFromTime(hour: 13, minute: 45), DateFromTime(hour: 13, minute: 55), DateFromTime(hour: 14, minute: 1), DateFromTime(hour: 14, minute: 31)]
    case 16:
        //Pre Testing
